...
def van_multiimage_input(num_layers, pretrained=False, num_input_images=1):
    ...
    if pretrained:
        ...
        loaded["patch_embed1.weight"] = torch.cat([loaded["conv1.weight"]] * num_input_images, 1) / num_input_images
    ...
    def __init__(self, size_encoder, pretrained, num_input_images=1):
        ...
        if num_input_images > 1:
            ...
            self.encoder = create_model(
                "van_{}".format(size_encoder), pretrained=False, num_classes=None, drop_rate=0.0, drop_path_rate=0.1, drop_block_rate=None
            )
            ...
            if pretrained:
                ...
                pretrined_state_dict["patch_embed1.proj.weight"] = (
                    torch.cat([pretrined_state_dict["patch_embed1.proj.weight"]] * num_input_images, 1) / num_input_images
                )
