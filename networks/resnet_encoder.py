...
# These modifications were conducted mainly for running the scripts on any environment.
#
...
class LiteMonoResnetEncoder(ResnetEncoder):
    def __init__(self, num_layers, pretrained, num_input_images=1):
        super().__init__(num_layers, pretrained, num_input_images)
