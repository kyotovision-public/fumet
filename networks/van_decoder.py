...
from .da_att import CAM_Module, PAM_Module
...
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, out_planes, ratio=16):
        ...
        self.fc = nn.Sequential(
            nn.Linear(in_planes, in_planes // ratio, bias=False), nn.ReLU(inplace=True), nn.Linear(in_planes // ratio, in_planes, bias=False)
        )
        self.sigmoid = nn.Sigmoid()
